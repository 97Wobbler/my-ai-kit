...
In Claude Code, plugin skills are invoked with the plugin namespace, for example `/edu-sim:edu-sim`.
After `report.md` is created, present that file to the user with the native file presentation flow. Do not paste all persona responses into chat.
