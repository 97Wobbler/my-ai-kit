...
Use the Slackbox MCP tools when available, but keep tokens, workspace internals, local data paths, and transport details out of normal user-facing updates.
