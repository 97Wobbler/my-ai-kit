...
Claude Code plugin skills are namespaced. Users may call `/waypoint:waypoint`, `/waypoint:init`, `/waypoint:audit`, `/waypoint:deep-audit`, `/waypoint:doctor`, or `/waypoint:tracks`.
