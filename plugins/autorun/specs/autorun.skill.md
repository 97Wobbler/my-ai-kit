...
name: autorun
description: >
  Turn a broad coding request into a dependency-aware project-root workplan.yaml,
...
outputs:
  claude: plugins/autorun/skills/claude/autorun/SKILL.md
  codex: plugins/autorun/skills/codex/autorun/SKILL.md
---
